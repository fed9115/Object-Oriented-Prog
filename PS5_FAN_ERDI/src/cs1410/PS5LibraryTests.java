...
public class PS5LibraryTests
{
    ...
    {
        assertEquals("I\tLOVE\nyou\n", PS5Library.scannerToString(new Scanner("I\tLOVE\nyou")));
    }
    ...
    {
        assertEquals('b', PS5Library.pickCharThatFollowsPattern("abababa", "aba", new Random()));
    }
    ...
    public void testGetCharsThatFollowPattern2 ()
    {
        ...
        list.add('c');
        list.add('d');
        assertEquals(list, PS5Library.getCharsThatFollowPattern("abcabd", "ab"));
    }
}
